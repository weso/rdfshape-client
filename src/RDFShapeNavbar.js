        ...
        <Navbar.Collapse color="white" id="basic-navbar-nav">
          <Nav className="mr-auto">
            ...
            >
              ...
              <NavDropdown.Item href={API.routes.client.dataVisualizeRoute}>
                Visualization (Graphviz)
              </NavDropdown.Item>
              <NavDropdown.Item href={API.routes.client.cytoVisualizeRoute}>
            ...
            <NavDropdown title="ShEx" id="nav-dropdown-shex">
              ...
              <NavDropdown.Item href={API.routes.client.shExVisualizeRoute}>
